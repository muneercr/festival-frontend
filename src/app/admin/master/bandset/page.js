...
const Bandset = () => {
  ...
  return (
    <DefaultLayout>
       {showModal && <AddBandset
        closeModal={addtoggleModal}  />} 
        {editModal && <EditBandset
        closeModal={editToggleModal}
        id={bandId}/> }
    ...
    <div className="grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
      <div className="col-span-3 flex items-center">
        <p className="font-medium">Bandset Name</p>
      </div>
      ...
      <div className="col-span-1 flex items-center">
        <p className="font-medium">Bidding Due</p>
      </div>
      <div className="col-span-1 flex items-center">
    ...
    {bansList?.map((product, key) => (
      ...
      >
        ...
        <div className="col-span-1 flex items-center">
          <p className="text-sm text-black dark:text-white">
            ₹{product.bandsetPrice}
          </p>
        </div>
        <div className="col-span-1 flex items-center">
          <p className="text-sm text-black dark:text-white">{product.bntBookingPeriod}</p>
        </div>
        <div className="col-span-1 flex items-center">
          <p className="text-sm text-meta-3">₹{product.biddingDuedays}</p>
        </div>
        <div className="flex items-center space-x-3.5">
                    <button className="hover:text-primary" 
                    onClick={()=>deleteBand(product._id)}>
                      <svg
                        className="fill-current"
                        width="18"
                        height="18"
