                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/admin/master/elephant"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/master/elephant" &&
                                "text-white"
                              }`}
                            >
                              elephant
                          ...
                          <li>
                            <Link
                              href="/admin/master/bandset"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/master/bandset" &&
                                "text-white"
                              }`}
                            >
                              bandset
                          ...
                          <li>
                            <Link
                              href="/admin/master/thambolam"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/master/thambolam" &&
                                "text-white"
                              }`}
                            >
                              thambolam
                          ...
                          <li>
                            <Link
                              href="/admin/master/shinkarimelam"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/master/shinkarimelam" &&
                                "text-white"
                              } `}
                            >
                              shinkarimelam
